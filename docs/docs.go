...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/stock-events": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.StockEvent"
                            }
                        }
                    }
                }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Stock event data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateStockEventRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/stock-events/product/{product_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "models.CreateStockEventRequest": {
            "type": "object",
            "required": [
                "product_id",
                "qty",
        ...
        "models.StockEvent": {
            ...
            "properties": {
                ...
                "source": {
                    "description": "pos, dashboard, online",
                    "type": "string"
                },
                "transaction_id": {
                    "type": "string"
                ...
                "type": {
                    "description": "sale, restock, reject, adjustment, opening_stock",
                    "type": "string"
                },
                "user_id": {
                    "type": "string"
